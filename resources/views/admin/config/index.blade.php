                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('value') is-invalid @enderror" name="value"
                                        value="{{ old('value') }}" requiredautofocus>
                                ...
                                <label for="key" class="col-md-4 col-form-label text-md-right">Enter Config Key</label>

                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('key') is-invalid @enderror" name="key"
                                        name="{{ old('key') }}" requiredautofocus>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST"
                                            ...
                                            @csrf
                                            <input type="hidden" value="_method" value="DELETE" />
